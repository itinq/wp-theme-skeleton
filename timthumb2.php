...
if(! defined('CURL_TIMEOUT') ) 			define ('CURL_TIMEOUT', 60);				// Timeout duration for Curl. This only applies if you have Curl installed and aren't using PHP's default URL fetching mechanism.
